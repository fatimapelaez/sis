...
<div style="width: 800px; text-align: center; margin-left: 600px; margin-right: 100px;"> <!-- CONSERTAR!!!! -->
	<table>
		...
		<tr>
			...
			<td>Teste</td>
			<td>Teste</td>
			<td><a href="AlterarFornecedor.jsp"><img src="images/edit_icon.png" style="width: 20px; height: 20px;"></a></td>
			<td><a><img src="images/delete_icon.png" style="width: 20px; height: 20px;"></a></td>
			<td><a href="ConsultarFornecedor.jsp"><img src="images/return_icon.png" style="width: 20px; height: 20px;"></a></td>
		</tr>
		<tr>
			<td>Teste</td>
			<td>Teste</td>
