...
<div style="width: 800px; text-align: center; margin-left: 600px; margin-right: 100px;"> <!-- CONSERTAR!!!! -->
	<table>
		...
		<tr>
			...
			<td>Teste</td>
			<td>Teste</td>
			<td><a href="AlterarInsumo.jsp"><img src="images/edit_icon.png" style="width: 20px; height: 20px;"></a></td>
			<td><a><img src="images/delete_icon.png" style="width: 20px; height: 20px;"></a></td>
			<td><a href="ConsultarInsumo.jsp"><img src="images/return_icon.png" style="width: 20px; height: 20px;"></a></td>
		</tr>
	</table>
</div>
