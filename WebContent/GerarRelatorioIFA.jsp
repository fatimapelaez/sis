	...
	<div id="container_demo">
		<div id="wrapper">
			<div id="consultarInsumo" class="animate form">
				<form action="RelatorioIFA.jsp" autocomplete="on">

					<br />
					<h3>Consulta para gerar relatório IFA</h3>
					...
					<p>
						<label for="insumo"> Insumo </label> <input id="insumo" name="insumo"
							required="required" type="text" style="width: 200px;"  />	
					</p>				
					<br />		
